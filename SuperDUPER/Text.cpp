...
Text::Text(std::string text, Color color, Rectangle position, SDL_Renderer* renderer, TTF_Font* font)
	:text{ text }, color{ color }, position{ position }
{
	//Create the surface
	SDL_Surface* surfaceText{ TTF_RenderText_Solid(font, text.c_str(), color.toSDLColor()) };
